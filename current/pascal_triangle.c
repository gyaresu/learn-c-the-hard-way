...
int main() {
    ...
    // sizeof int pointer: http://stackoverflow.com/questions/20721294/size-of-int-and-sizeof-int-pointer-on-a-64-bit-machine#20721311
    // sizeof(int) is implementation defined whereas (int*)
    // is just the address to some area of  memory
